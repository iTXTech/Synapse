...
use synapse\inventory\FurnaceRecipe;
use synapse\inventory\ShapedRecipe;
use synapse\inventory\ShapelessRecipe;
use synapse\item\enchantment\Enchantment;
use synapse\item\enchantment\EnchantmentList;
use synapse\utils\BinaryStream;
