...
class QueryRegenerateEvent extends Event{
	...
	public function __construct(Server $server, $timeout = 5){
		...
		$this->server_engine = $server->getName() . " " . $server->getSynapseVersion();
		$this->map = "world";
		$this->numPlayers = $poc;
		$this->maxPlayers = $pc;
	...
	/**
	 * @param \synapse\plugin\Plugin[] $plugins
	 */
